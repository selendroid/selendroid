 ...
 * the License.
 */
package io.selendroid.server.server;
...
import io.selendroid.server.server.handler.Actions;
import io.selendroid.server.server.handler.AddCallLog;
import io.selendroid.server.server.handler.AddCookie;
import io.selendroid.server.server.handler.BackgroundApp;
import io.selendroid.server.server.handler.CaptureScreenshot;
import io.selendroid.server.server.handler.ClearElement;
import io.selendroid.server.server.handler.ClickElement;
import io.selendroid.server.server.handler.DeleteCookies;
import io.selendroid.server.server.handler.DeleteNamedCookie;
import io.selendroid.server.server.handler.DeleteSession;
import io.selendroid.server.server.handler.DoubleTapOnElement;
import io.selendroid.server.server.handler.Down;
import io.selendroid.server.server.handler.ElementLocation;
import io.selendroid.server.server.handler.FindChildElement;
import io.selendroid.server.server.handler.FindChildElements;
import io.selendroid.server.server.handler.FindElement;
import io.selendroid.server.server.handler.FindElements;
import io.selendroid.server.server.handler.Flick;
import io.selendroid.server.server.handler.ForceGcExplicitly;
import io.selendroid.server.server.handler.FrameSwitchHandler;
import io.selendroid.server.server.handler.GetCapabilities;
import io.selendroid.server.server.handler.GetCommandConfiguration;
import io.selendroid.server.server.handler.GetContext;
import io.selendroid.server.server.handler.GetContexts;
import io.selendroid.server.server.handler.GetCookies;
import io.selendroid.server.server.handler.GetCurrentUrl;
import io.selendroid.server.server.handler.GetElementAttribute;
import io.selendroid.server.server.handler.GetElementDisplayed;
import io.selendroid.server.server.handler.GetElementEnabled;
import io.selendroid.server.server.handler.GetElementLocationInView;
import io.selendroid.server.server.handler.GetElementSelected;
import io.selendroid.server.server.handler.GetElementSize;
import io.selendroid.server.server.handler.GetElementTagName;
import io.selendroid.server.server.handler.GetPageTitle;
import io.selendroid.server.server.handler.GetScreenOrientation;
import io.selendroid.server.server.handler.GetScreenState;
import io.selendroid.server.server.handler.GetText;
import io.selendroid.server.server.handler.GetWindowSize;
import io.selendroid.server.server.handler.GoBack;
import io.selendroid.server.server.handler.GoForward;
import io.selendroid.server.server.handler.InspectorTap;
import io.selendroid.server.server.handler.ListSessions;
import io.selendroid.server.server.handler.LogElement;
import io.selendroid.server.server.handler.LogElementTree;
import io.selendroid.server.server.handler.LongPressOnElement;
import io.selendroid.server.server.handler.Move;
import io.selendroid.server.server.handler.NewSession;
import io.selendroid.server.server.handler.OpenUrl;
import io.selendroid.server.server.handler.ReadCallLog;
import io.selendroid.server.server.handler.Refresh;
import io.selendroid.server.server.handler.ResumeApp;
import io.selendroid.server.server.handler.RotateScreen;
import io.selendroid.server.server.handler.Scroll;
import io.selendroid.server.server.handler.SendKeyToActiveElement;
import io.selendroid.server.server.handler.SendKeys;
import io.selendroid.server.server.handler.SetCommandConfiguration;
import io.selendroid.server.server.handler.SetScreenState;
import io.selendroid.server.server.handler.SetSystemProperty;
import io.selendroid.server.server.handler.SingleTapOnElement;
import io.selendroid.server.server.handler.SubmitForm;
import io.selendroid.server.server.handler.SwitchContext;
import io.selendroid.server.server.handler.UnknownCommandHandler;
import io.selendroid.server.server.handler.Up;
import io.selendroid.server.server.handler.alert.Alert;
import io.selendroid.server.server.handler.alert.AlertAccept;
import io.selendroid.server.server.handler.alert.AlertDismiss;
import io.selendroid.server.server.handler.alert.AlertSendKeys;
import io.selendroid.server.server.handler.extension.ExtensionCallHandler;
import io.selendroid.server.server.handler.network.GetNetworkConnectionType;
import io.selendroid.server.server.handler.script.ExecuteAsyncScript;
import io.selendroid.server.server.handler.script.ExecuteScript;
import io.selendroid.server.server.handler.timeouts.AsyncTimeoutHandler;
import io.selendroid.server.server.handler.timeouts.SetImplicitWaitTimeout;
import io.selendroid.server.server.handler.timeouts.TimeoutsHandler;
import io.selendroid.server.server.model.DefaultSelendroidDriver;
