...
public class AndroidServlet extends BaseServlet {
  ...
  protected void init() {
    ...
    getHandler.put(   "/wd/hub/session/:sessionId/alert_text", Alert.class);
    postHandler.put(  "/wd/hub/session/:sessionId/alert_text", AlertSendKeys.class);
    postHandler.put(  "/wd/hub/session/:sessionId/accept_alert", AlertAccept.class);
    ...
    postHandler.put(  "/wd/hub/session/:sessionId/dismiss_alert", AlertDismiss.class);
    ...
    postHandler.put("/wd/hub/session/:sessionId/window/:windowHandle/position", UnknownCommandHandler.class);
    getHandler.put("/wd/hub/session/:sessionId/window/:windowHandle/position", UnknownCommandHandler.class);
    postHandler.put("/wd/hub/session/:sessionId/window/:windowHandle/maximize", UnknownCommandHandler.class);
    ...
    getHandler.put("/wd/hub/session/:sessionId/element/:id/css/:propertyName", UnknownCommandHandler.class);
