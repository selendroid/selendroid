...
public class AdbRoll extends BaseSelendroidStandaloneHandler {

	public AdbRoll(String mappedUri) {
		super(mappedUri);
	}
	...
	protected Response handleRequest(HttpRequest request, JSONObject payload) throws JSONException {
	    ...
	    String command =
	        String.format("shell input trackball roll %s %s", payload.getString("dx"), payload.getString("dy"));
