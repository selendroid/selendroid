 ...
 * the License.
 */
package org.openqa.selendroid.testapp.webdrivertestserver.handler;
...
public class PathAugmentingStaticFileHandler extends ImprovedStaticFileHandler {
  ...
  protected class PathAugmentingFileWorker extends FileWorker {
    private PathAugmentingFileWorker(HttpRequest request, HttpResponse response, HttpControl control) {
