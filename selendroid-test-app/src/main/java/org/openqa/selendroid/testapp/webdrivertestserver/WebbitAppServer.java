...
package org.openqa.selendroid.testapp.webdrivertestserver;
...
import org.openqa.selendroid.testapp.webdrivertestserver.handler.BasicAuthHandler;
import org.openqa.selendroid.testapp.webdrivertestserver.handler.LastPathSegmentHandler;
import org.openqa.selendroid.testapp.webdrivertestserver.handler.PathAugmentingStaticFileHandler;
import org.openqa.selendroid.testapp.webdrivertestserver.handler.PathForwardingHandler;
import org.openqa.selendroid.testapp.webdrivertestserver.handler.QuitQuitQuitHandler;
import org.openqa.selendroid.testapp.webdrivertestserver.handler.RedirectHandler;
import org.openqa.selendroid.testapp.webdrivertestserver.handler.SleepHandler;
import org.openqa.selendroid.testapp.webdrivertestserver.handler.UploadFileHandler;
...
public class WebbitAppServer implements AppServer {
  ...
  public WebbitAppServer() {
    ...
    System.out.println("listening on port: " + this.getHttpPort());
  }
  ...
  private WebServer configureServer(int port) {
    ...
    forwardPathToHandlerUnderCommon("/encoding", new StringHttpHandler("text/html", SHALOM_TEXT,
        Charsets.UTF_16), server);
    forwardPathToHandlerUnderCommon("/upload", new PathMatchHandler("^$", new UploadFileHandler()),
        server);
  ...
  public static void main(String[] args) {
    ...
    server.start();
    System.out.printf("Started server on port %s, https on %s%n", server.getHttpPort(),
        server.getHttpsPort());
