...
public class InProject {
   ...
   * @throws RuntimeException wrapped FileNotFoundException if file could not be found
   */
  public static File locate(String path) {
    ...
    throw new RuntimeException(new FileNotFoundException("Could not find " + path
        + " in the project"));
  }
}
